...
<p><a href="https://github.com/WeraStremedlowska/OpenWeatherProject/blob/main/.github/workflows/ci.yml">ci.yml</a> file was used for the GitHub workflow<br /><br /><a href="https://github.com/dorny/test-reporter">dorny/test-reporter@v1</a> was used to generate reports after each CI run<br /><br /></p>
...
<p>2. Copy the HTTPS project link from the GitHub repository:&nbsp;<br /><a href="https://github.com/WeraStremedlowska/OpenWeatherProject.git">https://github.com/WeraStremedlowska/OpenWeatherProject.git</a></p>
