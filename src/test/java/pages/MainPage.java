...
public class MainPage extends FooterMenuPage<MainPage> {
    ...
    @FindBy(xpath = "//div[@class = 'grid-container api-icons']//h3")
    ...
    @FindBy(className = "section.grey-background")
    private WebElement oneCallAPI3;

    @FindBy(xpath = "//h2//a[@href = '/api/one-call-3']")
    private WebElement oneCallAPI3Link;
    ...
    public String getEightDaysForecastCalendarSequenceText() {
        ...
        return DateTimeUtils.getEightDaysFromDate(monNum, date, Year.now().getValue());
    }
