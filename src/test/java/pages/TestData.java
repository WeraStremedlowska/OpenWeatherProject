...
public class TestData {
    ...
    public static Object[][] billingDetailsTestDataProvider() {

        return new Object[][] {
                {"firstNameIsEmpty", "Florida", "2019", "", "User", "1234567890", "test@example.com", "Cannot be blank"},
                {"lastNameIsEmpty", "Florida", "2019", "Test", "", "1234567890", "test@example.com", "Cannot be blank"},
                {"phoneNumberIsEmpty", "Florida", "2019", "Test", "User", "", "test@example.com", "Cannot be blank"},
                {"emailIsEmpty", "Florida", "2019", "Test", "User", "1234567890", "", "Cannot be blank"}
